		...
		<div id="book">
			...
			<div style="text-align: center">
				<c:if test="${empty sessionScope.cart.items}">
					...
					<div>
						<span id="cartLastName" style="color: #FCD1D1">您的购物车中没有商品</span>
					</div>
				</c:if>
				<c:if test="${not empty sessionScope.cart.items}">

					<span>您的购物车中有<span id="cartTotalCount" style="color: #FCD1D1">${sessionScope.cart.totalCount}</span>件商品</span>
					<div>
